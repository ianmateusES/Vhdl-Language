...
HD_PWD='C:/Users/ianma/Documents/Simula/Pratica_2_completa/Pratica_2_completa.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Pratica_2_completa.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Pratica_2_completa.tcl
