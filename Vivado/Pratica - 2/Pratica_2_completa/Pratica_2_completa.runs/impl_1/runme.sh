...
HD_PWD='C:/Users/ianma/Documents/Simula/Pratica_2_completa/Pratica_2_completa.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Pratica_2_completa.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Pratica_2_completa.tcl -notrace
